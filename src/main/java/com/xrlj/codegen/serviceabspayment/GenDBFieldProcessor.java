...
public class GenDBFieldProcessor extends GenDBField2BeanProcessor {
    ...
    static {
        try {
            Class.forName(Constants.ServiceAbsPayment.DRIVER);
    ...
    public Connection getConnection() {
        ...
        try {
            conn = DriverManager.getConnection(Constants.ServiceAbsPayment.URL, Constants.ServiceAbsPayment.USERNAME, Constants.ServiceAbsPayment.PASSWORD);
    ...
    public String getJavaFileOutPackagePath() {
        return Constants.ServiceAbsPayment.projectPackage.concat(".gen.db.tables");
    }
}
